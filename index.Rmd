...
# Use pacman to install and load all required packages
pacman::p_load(
  tidyverse, learnr,  dplyr,  tidyr,  ggplot2,  readr,  tibble, readxl, 
  writexl, openxlsx, rio, officer, magrittr, flowCorem, agricolae, stats
)
```
...
separated_date <- storms %>%                             # pipe pass the data
  tidyr::separate(                            # function that split
    col = date,                        # old column
    into = c("year", "month", "day"),  # new columns
    sep = "-")                         # separate by -
